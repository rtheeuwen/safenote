...
public class AbstractAesServiceTest {
	...
	public void encryptionIsDoneCorrectly() {
		SecretKeySpec key = KeyUtils.keyStoreFromByteArray(KeyUtils.generateKeyStore(new SecureRandom())).getAes();
		String test = "test";
	...
	public void decryptionFailsWithInvalidKey() {
		...
		key = KeyUtils.keyStoreFromByteArray(KeyUtils.generateKeyStore(new SecureRandom())).getAes();
