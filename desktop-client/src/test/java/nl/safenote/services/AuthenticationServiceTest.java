...
public class AuthenticationServiceTest {
	...
	private void verifyCorrectBehavior(AuthenticationService authenticationService) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
		...
		KeyStore keyStore = KeyUtils.keyStoreFromByteArray(deciphered);

		verify(synchronizationService).enlist(keyStore.getPublicKey());
		verify(cryptoService).init(keyStore.getAes(), keyStore.getHmac(), keyStore.getPrivateKey());
	}
}
